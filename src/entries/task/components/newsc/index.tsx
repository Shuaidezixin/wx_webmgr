	...
	render() {
		...
		return (
			<div className="chatcreate-task">
				{targetSubType && targetSubType == "SC_add_note" && (
					<div className="group">
				...
				{targetSubType && targetSubType == "SC_dakaiyulan" && (
					<SimpleTask
						labelName="打开预览收藏（随机）"
						type="SC_dakaiyulan"
				...
				{targetSubType && targetSubType == "SC_read" && (
					<SimpleTask
						labelName="阅读收藏（随机）"
						type="SC_read"
						onOk={this.saveClick.bind(this)}
				...
				{targetSubType && targetSubType == "SC_delete" && (
					<SimpleTask
						labelName="删除收藏（随机）"
						type="SC_delete"
						onOk={this.saveClick.bind(this)}
				...
				{targetSubType && targetSubType == "SC_zhuanfa_link_pyq" && (
					<SimpleTask
				...
				{targetSubType && targetSubType == "SC_zhuanfa_link_chat" && (
					<SimpleTask
				...
				{targetSubType && targetSubType == "SC_shaixuan" && (
					<SimpleTask
						labelName="筛选收藏（随机）"
						type="SC_shaixuan"
						onOk={this.saveClick.bind(this)}
				...
				{targetSubType && targetSubType == "SC_zhuanfa_note_pyq" && (
					<SimpleTask
				...
				{targetSubType && targetSubType == "SC_zhuanfa_note_chat" && (
					<SimpleTask
