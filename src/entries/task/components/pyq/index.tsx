	...
	render() {
		...
		return (
			<div className="taskcreate-pyq">
				{workData && workData.SendPyq && (
					<div className="group">
						<div className="group-title">
							<div className="text">发朋友圈</div>
							<Button
								className="btn"
								size="small"
								type="primary"
				...
				{workData && workData.ForwardLinkPyq && (
					<SimpleTask
				...
				{workData && workData.Pyq_share_link && (
					<SimpleTask
						labelName="分享第三方链接"
						type="pyq_share_link"
						onOk={this.saveClick.bind(this)}
