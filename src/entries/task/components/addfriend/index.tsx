...
export default class AddFriend extends React.PureComponent<Props, State> {
	...
	async saveClick(type: string) {
		...
		if (type == "jiansuo") {
			...
			let mobile: any = [];
			params.execute_hi = jiansuo_time ? jiansuo_time.format("HHmm") : 0;
			if (phoneType == "random") {
	...
	render() {
		...
		return (
			<div className="task-addfriend">
				{workData && workData.SearchFriend && (
					<div className="group">
				...
				{workData && workData.MailListFriend && (
					<div className="group">
						<div className="group-title">
				...
				{(!workData ||
					(!workData.SearchFriend &&
						!workData.MailListFriend &&
						!workData.GroupFriend)) && (
